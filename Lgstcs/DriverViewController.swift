            ...
            if error == nil {
                ...
                if let objects = objects as? [PFObject] {
                    for object in objects {
                        ...
                        let x = Load(aIdent: (object["Ident"] as! Int),  aPickupAddress: (object["pickupAddress"] as! String), aPickupCity: (object["pickupCity"] as! String), aPickupState: (object["pickupState"] as! String), aALat: (object["aLng"] as! String), aALng: (object["aLat"] as! String), aDeliveryAddress: (object["deliveryAddress"] as! String), aDeliveryCity: (object["deliveryCity"] as! String), aDeliveryState: (object["deliveryState"] as! String), aBLat: (object["bLat"] as! String), aBLng: (object["bLng"] as! String), aTypeOfLoad: (object["typeofLoad"] as! String), aWeight: (object["weight"] as! String),  aId: (object["objectID"] as! String), aPhoneNumber: (object["phoneNumber"] as! String),  aContactName: (object["contactName"] as! String))
